...
# Draw the graph
pos = nx.spring_layout(G1)  # Choose a layout for the nodes
nx.draw_networkx(G1, pos=pos, with_labels=True, node_size=200, node_color='skyblue', font_size=8, font_color='black', font_weight='bold', edge_color='gray', width=1.0, alpha=0.7)
plt.title("Network Graph with Edges")
plt.show()